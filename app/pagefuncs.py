...
def give_head(client, title, refresh=None):
    ...
    if refresh is not None:
        ...
        """)
    try:
        with open('app/black_style.css', 'r', encoding='utf-8') as file:
            client.sendall(f"""\
...
def handle_monitor(client, pars):
    ...
    try:
        with open('app/monitor.html', 'r', encoding='utf-8') as file:
            client.sendall(
...
def handle_settings(client, request, sets):
    ...
    try:
        with open('app/sets_menu.html', 'r', encoding='utf-8') as file:
            client.sendall(file.read())
    except OSError as exc:
        print('Error:', exc)
    if sets_dict == 'wifi':
        try:
            with open('app/sets_wifi.html', 'r', encoding='utf-8') as file:
                client.sendall(
        ...
        try:
            with open('app/sets_solution.html', 'r', encoding='utf-8') as file:
                client.sendall(
        ...
        try:
            with open('app/sets_power.html', 'r', encoding='utf-8') as file:
                client.sendall(
        ...
        try:
            with open('app/sets_light.html', 'r', encoding='utf-8') as file:
                client.sendall(
        ...
        try:
            with open('app/sets_sensors.html', 'r', encoding='utf-8') as file:
                client.sendall(
